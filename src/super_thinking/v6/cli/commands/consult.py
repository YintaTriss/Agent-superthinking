...
def consult_cmd(
    ...
    if mock:
        ...
        renderer._console.print(f"[bold {renderer.COLOR_SECONDARY}]Domain:[/bold {renderer.COLOR_SECONDARY}] {expert['domain']}")
        renderer._console.print(f"[bold {renderer.COLOR_SECONDARY}]Methods:[/bold {renderer.COLOR_SECONDARY}] {expert['methods']}")
        renderer._console.print()
        renderer._console.print(f"[bold {renderer.COLOR_PRIMARY}]> Question:[/bold {renderer.COLOR_PRIMARY}]")
