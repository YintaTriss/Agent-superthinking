...
class FileRecorder:
    ...
    def on_roster_change(self, change: RosterChange) -> None:
        self._write("roster_change", {
            "action": change.action,
            "expert_id": str(change.expert_id) if change.expert_id else None,
            "reason": change.reason or "",
        })

    def on_session_aborted(self, reason: str) -> None:
        self._write("session_aborted", {"reason": reason})
